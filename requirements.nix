...
let
  ...
  generated = self: {
    ...
    "discord-py" = python.mkDerivation {
      name = "discord-py-1.3.4";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/a7/95/c2634ba45abac010e36e042c2226e91f445f1cfd765f7b5aeb40b0df6842/discord.py-1.3.4.tar.gz";
